...
public static class EndpointExtensions
{
	...
	{
		builder.Services.AddScoped<global::TestNamespace.SimpleEndpoint>();
	...
	{
		// GET: /api/simple/{id}
		RouteHandlerBuilder get_Simple_0 = app
			.MapGet("/api/simple/{id}", async (
				global::TestNamespace.GetRequest request,
				[FromServices] global::TestNamespace.SimpleEndpoint endpoint,
				CancellationToken ct) => await endpoint.Handle(request, ct))
			.WithTags("Simple")
			.WithName("get_Simple_0");

		global::TestNamespace.SimpleEndpoint.Configure(get_Simple_0);
