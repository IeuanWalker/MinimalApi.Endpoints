...
public static class EndpointExtensions
{
	...
	{
		builder.Services.AddScoped<global::TestNamespace.FindUserEndpoint>();
	...
	public static WebApplication MapEndpointsFromTestAssembly(this WebApplication app)
	{
		...
		RouteHandlerBuilder get_Users_0 = app
			.MapGet("/api/users/{id}", async (
				global::TestNamespace.FindUserRequest request,
				[FromServices] global::TestNamespace.FindUserEndpoint endpoint,
				CancellationToken ct) => await endpoint.Handle(request, ct))
			.WithTags("Users")
			.WithName("get_Users_0");

		global::TestNamespace.FindUserEndpoint.Configure(get_Users_0);
		global::IeuanWalker.MinimalApi.Endpoints.OpenApiExtensions.WithNullableResponse(get_Users_0);
