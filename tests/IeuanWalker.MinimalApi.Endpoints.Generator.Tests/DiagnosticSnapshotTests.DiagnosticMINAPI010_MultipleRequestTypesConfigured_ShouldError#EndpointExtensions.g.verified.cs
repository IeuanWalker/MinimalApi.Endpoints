...
public static class EndpointExtensions
{
	...
	{
		builder.Services.AddScoped<global::TestNamespace.MultipleRequestTypesEndpoint>();
	...
	public static WebApplication MapEndpointsFromTestAssembly(this WebApplication app)
	{
		...
		RouteHandlerBuilder post_Items_0 = app
			.MapPost("/api/items", async (
				...
				[FromServices] global::TestNamespace.MultipleRequestTypesEndpoint endpoint,
				CancellationToken ct) => await endpoint.Handle(request, ct))
			.WithTags("Items")
			.WithName("post_Items_0");

		global::TestNamespace.MultipleRequestTypesEndpoint.Configure(post_Items_0);
