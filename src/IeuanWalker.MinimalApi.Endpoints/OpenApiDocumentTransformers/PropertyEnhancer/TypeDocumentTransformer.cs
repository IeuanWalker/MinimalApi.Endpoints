...
/// <summary>
/// OpenAPI document transformer that ensures all property types and formats are correctly documented. This transformer
/// runs before other transformers to establish a baseline of correct type information. It handles: - Schema properties
/// (primitives, arrays, nested objects) - Query and path parameters - IFormFile and IFormFileCollection types -
/// Nullable types
/// </summary>
